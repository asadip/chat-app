...
const ChatBox = () => {
  ...
  return (
    <div className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-10 max-md:mt-14 2xl:pr-40'>
      ...
      {mode === 'image' && (
        <label className='inline-flex items-center gap-2 mb-3 text-sm mx-auto'>
          <p className='text-xs'>Piblish Generated Image to Community</p>
          <input 
            type="checkbox" 
