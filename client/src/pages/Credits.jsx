...
const Credits = () => {
  ...
  return (
    <div className='max-w-7x1 h-screen overflow-y-scroll mx-auto px-4 sm:px-6 1g:px-8 py-12'>
      <h2 className='text-3x1 font-semibold text-center mb-10 xl:mt-30 text-gray-800 dark:text-white'>
        Credit Plans
      </h2>
      <div className='flex flex-wrap justify-center gap-8'>
        {plans.map((plan)=>(
          <div key={plan._id} className={`border border-gray-200 dark:border-purple-700 rounded-lg 
            shadow hover:shadow-lg transition-shadow p-6 flex flex-col 
